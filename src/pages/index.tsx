  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless fleet management with zBus - Your ultimate solution for tracking, scheduling, and optimizing your fleet operations."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1587813369290-091c9d432daf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmbGVldHxlbnwwfHx8fDE2OTc0NjUyNzF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless fleet management with zBus - Your ultimate solution for tracking, scheduling, and optimizing your fleet operations.`}
            </Text>
            <Box
